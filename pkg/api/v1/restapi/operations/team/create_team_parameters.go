...
// CreateTeamParams contains all the bound params for the create team operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateTeamParams() beforehand.
