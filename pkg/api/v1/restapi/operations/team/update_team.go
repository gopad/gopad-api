...
type UpdateTeamHandlerFunc func(UpdateTeamParams) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateTeamHandlerFunc) Handle(params UpdateTeamParams) middleware.Responder {
	return fn(params)
}

// UpdateTeamHandler interface for that can handle valid update team params
type UpdateTeamHandler interface {
	Handle(UpdateTeamParams) middleware.Responder
}
...
/*UpdateTeam swagger:route PUT /teams/{teamID} team updateTeam
