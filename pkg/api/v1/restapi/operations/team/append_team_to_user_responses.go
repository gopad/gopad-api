...
/*AppendTeamToUserPreconditionFailed Failed to parse request body
...
/*AppendTeamToUserUnprocessableEntity User is already assigned
...
func (o *AppendTeamToUserUnprocessableEntity) WithPayload(payload *models.GeneralError) *AppendTeamToUserUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the append team to user unprocessable entity response
func (o *AppendTeamToUserUnprocessableEntity) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}
