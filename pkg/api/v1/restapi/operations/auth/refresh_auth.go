...
type RefreshAuthHandlerFunc func(RefreshAuthParams, *models.User) middleware.Responder

// Handle executing the request and returning a response
func (fn RefreshAuthHandlerFunc) Handle(params RefreshAuthParams, principal *models.User) middleware.Responder {
	return fn(params, principal)
}

// RefreshAuthHandler interface for that can handle valid refresh auth params
type RefreshAuthHandler interface {
	Handle(RefreshAuthParams, *models.User) middleware.Responder
}
