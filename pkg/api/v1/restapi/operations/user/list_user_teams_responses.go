...
// ListUserTeamsNotFoundCode is the HTTP code returned for type ListUserTeamsNotFound
const ListUserTeamsNotFoundCode int = 404

/*ListUserTeamsNotFound User not found

swagger:response listUserTeamsNotFound
*/
...
// NewListUserTeamsNotFound creates ListUserTeamsNotFound with default headers values
func NewListUserTeamsNotFound() *ListUserTeamsNotFound {

	return &ListUserTeamsNotFound{}
}

// WithPayload adds the payload to the list user teams not found response
func (o *ListUserTeamsNotFound) WithPayload(payload *models.GeneralError) *ListUserTeamsNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list user teams not found response
func (o *ListUserTeamsNotFound) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ListUserTeamsNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
