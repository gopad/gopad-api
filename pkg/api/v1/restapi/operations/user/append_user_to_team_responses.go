...
/*AppendUserToTeamPreconditionFailed Failed to parse request body
...
/*AppendUserToTeamUnprocessableEntity Team is already assigned
...
func (o *AppendUserToTeamUnprocessableEntity) WithPayload(payload *models.GeneralError) *AppendUserToTeamUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the append user to team unprocessable entity response
func (o *AppendUserToTeamUnprocessableEntity) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}
