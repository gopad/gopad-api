...
type ListUserTeamsHandlerFunc func(ListUserTeamsParams, *models.User) middleware.Responder

// Handle executing the request and returning a response
func (fn ListUserTeamsHandlerFunc) Handle(params ListUserTeamsParams, principal *models.User) middleware.Responder {
	return fn(params, principal)
}

// ListUserTeamsHandler interface for that can handle valid list user teams params
type ListUserTeamsHandler interface {
	Handle(ListUserTeamsParams, *models.User) middleware.Responder
}
...
/* ListUserTeams swagger:route GET /users/{user_id}/teams user listUserTeams
